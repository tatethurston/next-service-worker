define("./workbox-2872beb5.js", ["exports"], function (exports) {
  "use strict";
  ...
  class PrecacheStrategy extends Strategy {
    ...
    constructor(options = {}) {
      ...
      this._fallbackToNetwork =
        options.fallbackToNetwork === false ? false : true; // Redirected responses cannot be used to satisfy a navigation request, so
    ...
    async _handleFetch(request, handler) {
      ...
      {
        const cacheKey =
          (handler.params && handler.params.cacheKey) ||
          (await handler.getCacheKey(request, "read")); // Workbox is going to handle the route.
        // print the routing details to the console.
        ...
        logger.log(
          `Serving the precached url: ${getFriendlyURL(cacheKey.url)}`
        );
